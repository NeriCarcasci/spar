...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"operations", Value::array({Value("push"), Value("push"), Value("push"), Value("get_min"), Value("pop"), Value("top"), Value("get_min")})}, {"values", Value::array({Value(-2.0), Value(0.0), Value(-3.0), Value(), Value(), Value(), Value()})}})}, {"expected", Value::array({Value(), Value(), Value(), Value(-3.0), Value(), Value(0.0), Value(-2.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("push"), Value("push"), Value("get_min"), Value("pop"), Value("get_min")})}, {"values", Value::array({Value(1.0), Value(0.0), Value(), Value(), Value()})}})}, {"expected", Value::array({Value(), Value(), Value(0.0), Value(), Value(1.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("push"), Value("get_min"), Value("top")})}, {"values", Value::array({Value(5.0), Value(), Value()})}})}, {"expected", Value::array({Value(), Value(5.0), Value(5.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("push"), Value("push"), Value("push"), Value("push"), Value("get_min")})}, {"values", Value::array({Value(3.0), Value(2.0), Value(1.0), Value(0.0), Value()})}})}, {"expected", Value::array({Value(), Value(), Value(), Value(), Value(0.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("push"), Value("push"), Value("pop"), Value("push"), Value("get_min")})}, {"values", Value::array({Value(-1.0), Value(-2.0), Value(), Value(-3.0), Value()})}})}, {"expected", Value::array({Value(), Value(), Value(), Value(), Value(-3.0)})}, {"visible", Value(false)}})
    };
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        for (size_t j = 0; j < operations.size(); ++j) {
            ...
            if (op == "push") {
                ...
                out.push_back(toValue(obj.getMin()));
            } else {
