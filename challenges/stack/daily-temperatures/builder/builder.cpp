...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"temperatures", Value::array({Value(73.0), Value(74.0), Value(75.0), Value(71.0), Value(69.0), Value(72.0), Value(76.0), Value(73.0)})}})}, {"expected", Value::array({Value(1.0), Value(1.0), Value(4.0), Value(2.0), Value(1.0), Value(1.0), Value(0.0), Value(0.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"temperatures", Value::array({Value(30.0), Value(40.0), Value(50.0), Value(60.0)})}})}, {"expected", Value::array({Value(1.0), Value(1.0), Value(1.0), Value(0.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"temperatures", Value::array({Value(50.0)})}})}, {"expected", Value::array({Value(0.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"temperatures", Value::array({Value(60.0), Value(50.0), Value(40.0), Value(30.0)})}})}, {"expected", Value::array({Value(0.0), Value(0.0), Value(0.0), Value(0.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"temperatures", Value::array({Value(30.0), Value(30.0), Value(30.0)})}})}, {"expected", Value::array({Value(0.0), Value(0.0), Value(0.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"temperatures", Value::array({Value(70.0), Value(60.0), Value(80.0)})}})}, {"expected", Value::array({Value(2.0), Value(1.0), Value(0.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"temperatures", Value::array({Value(30.0), Value(100.0), Value(30.0), Value(100.0)})}})}, {"expected", Value::array({Value(1.0), Value(0.0), Value(1.0), Value(0.0)})}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"temperatures"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.dailyTemperatures(arg0);
