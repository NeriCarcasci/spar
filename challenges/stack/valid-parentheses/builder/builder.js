...
const TESTS = JSON.parse("[{\"input\":{\"s\":\"()\"},\"expected\":true,\"visible\":true},{\"input\":{\"s\":\"()[]{}\"},\"expected\":true,\"visible\":true},{\"input\":{\"s\":\"(]\"},\"expected\":false,\"visible\":false},{\"input\":{\"s\":\"(\"},\"expected\":false,\"visible\":false},{\"input\":{\"s\":\")(\"},\"expected\":false,\"visible\":false},{\"input\":{\"s\":\"{[]}\"},\"expected\":true,\"visible\":false},{\"input\":{\"s\":\"((()))\"},\"expected\":true,\"visible\":false}]");
...
function run(solutionPath, testsPath, challengePath) {
    ...
    const fn = resolveFunction(solution, ["isValid"]);
