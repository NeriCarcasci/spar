...
TESTS = json.loads('[{"input":{"s":"()"},"expected":true,"visible":true},{"input":{"s":"()[]{}"},"expected":true,"visible":true},{"input":{"s":"(]"},"expected":false,"visible":false},{"input":{"s":"("},"expected":false,"visible":false},{"input":{"s":")("},"expected":false,"visible":false},{"input":{"s":"{[]}"},"expected":true,"visible":false},{"input":{"s":"((()))"},"expected":true,"visible":false}]')
COMPARE_MODE = 'exact'
...
def run(solution_path, tests_path, challenge_path):
    ...
    for idx, case in enumerate(TESTS, start=1):
        ...
        fn = resolve_callable(module, ['is_valid'])
