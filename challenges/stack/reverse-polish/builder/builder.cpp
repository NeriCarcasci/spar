...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"tokens", Value::array({Value("2"), Value("1"), Value("+"), Value("3"), Value("*")})}})}, {"expected", Value(9.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"tokens", Value::array({Value("4"), Value("13"), Value("5"), Value("/"), Value("+")})}})}, {"expected", Value(6.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"tokens", Value::array({Value("3")})}})}, {"expected", Value(3.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"tokens", Value::array({Value("10"), Value("6"), Value("9"), Value("3"), Value("+"), Value("-11"), Value("*"), Value("/"), Value("*"), Value("17"), Value("+"), Value("5"), Value("+")})}})}, {"expected", Value(22.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"tokens", Value::array({Value("-1"), Value("-2"), Value("+")})}})}, {"expected", Value(-3.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"tokens", Value::array({Value("7"), Value("-3"), Value("/")})}})}, {"expected", Value(-2.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"tokens", Value::array({Value("0"), Value("1"), Value("/")})}})}, {"expected", Value(0.0)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"tokens"};
    bool failed = false;
