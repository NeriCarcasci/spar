...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"candidates", Value::array({Value(2.0), Value(3.0), Value(6.0), Value(7.0)})}, {"target", Value(7.0)}})}, {"expected", Value::array({Value::array({Value(2.0), Value(2.0), Value(3.0)}), Value::array({Value(7.0)})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"candidates", Value::array({Value(2.0), Value(3.0), Value(5.0)})}, {"target", Value(8.0)}})}, {"expected", Value::array({Value::array({Value(2.0), Value(2.0), Value(2.0), Value(2.0)}), Value::array({Value(2.0), Value(3.0), Value(3.0)}), Value::array({Value(3.0), Value(5.0)})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"candidates", Value::array({Value(2.0)})}, {"target", Value(1.0)}})}, {"expected", Value::array({})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"candidates", Value::array({Value(7.0)})}, {"target", Value(7.0)}})}, {"expected", Value::array({Value::array({Value(7.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"candidates", Value::array({Value(2.0), Value(3.0), Value(5.0)})}, {"target", Value(0.0)}})}, {"expected", Value::array({Value::array({})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"candidates", Value::array({Value(2.0), Value(3.0), Value(5.0), Value(7.0)})}, {"target", Value(10.0)}})}, {"expected", Value::array({Value::array({Value(2.0), Value(2.0), Value(2.0), Value(2.0), Value(2.0)}), Value::array({Value(2.0), Value(2.0), Value(3.0), Value(3.0)}), Value::array({Value(2.0), Value(3.0), Value(5.0)}), Value::array({Value(3.0), Value(7.0)}), Value::array({Value(5.0), Value(5.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"candidates", Value::array({Value(3.0), Value(5.0), Value(8.0)})}, {"target", Value(11.0)}})}, {"expected", Value::array({Value::array({Value(3.0), Value(3.0), Value(5.0)}), Value::array({Value(3.0), Value(8.0)})})}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"candidates", "target"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.combinationSum(arg0, arg1);
