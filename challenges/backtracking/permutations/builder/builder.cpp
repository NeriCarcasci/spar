...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(2.0), Value(3.0)})}})}, {"expected", Value::array({Value::array({Value(1.0), Value(2.0), Value(3.0)}), Value::array({Value(1.0), Value(3.0), Value(2.0)}), Value::array({Value(2.0), Value(1.0), Value(3.0)}), Value::array({Value(2.0), Value(3.0), Value(1.0)}), Value::array({Value(3.0), Value(1.0), Value(2.0)}), Value::array({Value(3.0), Value(2.0), Value(1.0)})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(0.0), Value(1.0)})}})}, {"expected", Value::array({Value::array({Value(0.0), Value(1.0)}), Value::array({Value(1.0), Value(0.0)})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0)})}})}, {"expected", Value::array({Value::array({Value(1.0)})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(-1.0), Value(0.0), Value(1.0)})}})}, {"expected", Value::array({Value::array({Value(-1.0), Value(0.0), Value(1.0)}), Value::array({Value(-1.0), Value(1.0), Value(0.0)}), Value::array({Value(0.0), Value(-1.0), Value(1.0)}), Value::array({Value(0.0), Value(1.0), Value(-1.0)}), Value::array({Value(1.0), Value(-1.0), Value(0.0)}), Value::array({Value(1.0), Value(0.0), Value(-1.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(3.0), Value(1.0)})}})}, {"expected", Value::array({Value::array({Value(1.0), Value(3.0)}), Value::array({Value(3.0), Value(1.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0)})}})}, {"expected", Value::array({Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0)}), Value::array({Value(1.0), Value(2.0), Value(4.0), Value(3.0)}), Value::array({Value(1.0), Value(3.0), Value(2.0), Value(4.0)}), Value::array({Value(1.0), Value(3.0), Value(4.0), Value(2.0)}), Value::array({Value(1.0), Value(4.0), Value(2.0), Value(3.0)}), Value::array({Value(1.0), Value(4.0), Value(3.0), Value(2.0)}), Value::array({Value(2.0), Value(1.0), Value(3.0), Value(4.0)}), Value::array({Value(2.0), Value(1.0), Value(4.0), Value(3.0)}), Value::array({Value(2.0), Value(3.0), Value(1.0), Value(4.0)}), Value::array({Value(2.0), Value(3.0), Value(4.0), Value(1.0)}), Value::array({Value(2.0), Value(4.0), Value(1.0), Value(3.0)}), Value::array({Value(2.0), Value(4.0), Value(3.0), Value(1.0)}), Value::array({Value(3.0), Value(1.0), Value(2.0), Value(4.0)}), Value::array({Value(3.0), Value(1.0), Value(4.0), Value(2.0)}), Value::array({Value(3.0), Value(2.0), Value(1.0), Value(4.0)}), Value::array({Value(3.0), Value(2.0), Value(4.0), Value(1.0)}), Value::array({Value(3.0), Value(4.0), Value(1.0), Value(2.0)}), Value::array({Value(3.0), Value(4.0), Value(2.0), Value(1.0)}), Value::array({Value(4.0), Value(1.0), Value(2.0), Value(3.0)}), Value::array({Value(4.0), Value(1.0), Value(3.0), Value(2.0)}), Value::array({Value(4.0), Value(2.0), Value(1.0), Value(3.0)}), Value::array({Value(4.0), Value(2.0), Value(3.0), Value(1.0)}), Value::array({Value(4.0), Value(3.0), Value(1.0), Value(2.0)}), Value::array({Value(4.0), Value(3.0), Value(2.0), Value(1.0)})})}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"nums"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto arg0 = toIntVector(raw0);
        auto result = sol.permute(arg0);
        ...
        if (hasExpectedLength) {
        ...
        } else if ("nested_unordered" == std::string("pair_target_1idx")) {
            ...
            passed = equalValues(gotValue, expected, "nested_unordered");
        }
