...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"board", Value::array({Value::array({Value("A"), Value("B"), Value("C"), Value("E")}), Value::array({Value("S"), Value("F"), Value("C"), Value("S")}), Value::array({Value("A"), Value("D"), Value("E"), Value("E")})})}, {"word", Value("ABCCED")}})}, {"expected", Value(true)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"board", Value::array({Value::array({Value("A"), Value("B"), Value("C"), Value("E")}), Value::array({Value("S"), Value("F"), Value("C"), Value("S")}), Value::array({Value("A"), Value("D"), Value("E"), Value("E")})})}, {"word", Value("SEE")}})}, {"expected", Value(true)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"board", Value::array({Value::array({Value("A"), Value("B"), Value("C"), Value("E")}), Value::array({Value("S"), Value("F"), Value("C"), Value("S")}), Value::array({Value("A"), Value("D"), Value("E"), Value("E")})})}, {"word", Value("ABCB")}})}, {"expected", Value(false)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"board", Value::array({Value::array({Value("A")})})}, {"word", Value("A")}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"board", Value::array({Value::array({Value("A"), Value("B")}), Value::array({Value("C"), Value("D")})})}, {"word", Value("ABCDE")}})}, {"expected", Value(false)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"board", Value::array({Value::array({Value("A"), Value("A"), Value("A")}), Value::array({Value("A"), Value("A"), Value("A")}), Value::array({Value("A"), Value("A"), Value("A")})})}, {"word", Value("AAAAAAAAA")}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"board", Value::array({Value::array({Value("A"), Value("B")}), Value::array({Value("C"), Value("D")})})}, {"word", Value("ACDB")}})}, {"expected", Value(true)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"board", "word"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto arg1 = toStringValue(raw1);
        auto result = sol.exist(arg0, arg1);
