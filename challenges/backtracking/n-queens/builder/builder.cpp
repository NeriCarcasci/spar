...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"n", Value(4.0)}})}, {"expected", Value::array({Value::array({Value(".Q.."), Value("...Q"), Value("Q..."), Value("..Q.")}), Value::array({Value("..Q."), Value("Q..."), Value("...Q"), Value(".Q..")})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"n", Value(1.0)}})}, {"expected", Value::array({Value::array({Value("Q")})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"n", Value(2.0)}})}, {"expected", Value::array({})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"n", Value(3.0)}})}, {"expected", Value::array({})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"n", Value(5.0)}})}, {"expected", Value::array({Value::array({Value("....Q"), Value("..Q.."), Value("Q...."), Value("...Q."), Value(".Q...")}), Value::array({Value("....Q"), Value(".Q..."), Value("...Q."), Value("Q...."), Value("..Q..")}), Value::array({Value("...Q."), Value(".Q..."), Value("....Q"), Value("..Q.."), Value("Q....")}), Value::array({Value("...Q."), Value("Q...."), Value("..Q.."), Value("....Q"), Value(".Q...")}), Value::array({Value("..Q.."), Value("....Q"), Value(".Q..."), Value("...Q."), Value("Q....")}), Value::array({Value("..Q.."), Value("Q...."), Value("...Q."), Value(".Q..."), Value("....Q")}), Value::array({Value(".Q..."), Value("....Q"), Value("..Q.."), Value("Q...."), Value("...Q.")}), Value::array({Value(".Q..."), Value("...Q."), Value("Q...."), Value("..Q.."), Value("....Q")}), Value::array({Value("Q...."), Value("...Q."), Value(".Q..."), Value("....Q"), Value("..Q..")}), Value::array({Value("Q...."), Value("..Q.."), Value("....Q"), Value(".Q..."), Value("...Q.")})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"n", Value(6.0)}})}, {"expected_length", Value(4.0)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"n"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.solveNQueens(arg0);
