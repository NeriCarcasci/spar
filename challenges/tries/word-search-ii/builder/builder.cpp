...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"board", Value::array({Value::array({Value("o"), Value("a"), Value("a"), Value("n")}), Value::array({Value("e"), Value("t"), Value("a"), Value("e")}), Value::array({Value("i"), Value("h"), Value("k"), Value("r")}), Value::array({Value("i"), Value("f"), Value("l"), Value("v")})})}, {"words", Value::array({Value("oath"), Value("pea"), Value("eat"), Value("rain")})}})}, {"expected", Value::array({Value("eat"), Value("oath")})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"board", Value::array({Value::array({Value("a"), Value("b")}), Value::array({Value("c"), Value("d")})})}, {"words", Value::array({Value("abcb")})}})}, {"expected", Value::array({})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"board", Value::array({Value::array({Value("a")})})}, {"words", Value::array({Value("a")})}})}, {"expected", Value::array({Value("a")})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"board", Value::array({Value::array({Value("a"), Value("a")}), Value::array({Value("a"), Value("a")})})}, {"words", Value::array({Value("aaaa"), Value("aaa"), Value("aa"), Value("a")})}})}, {"expected", Value::array({Value("a"), Value("aa"), Value("aaa"), Value("aaaa")})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"board", Value::array({Value::array({Value("a"), Value("b"), Value("c")}), Value::array({Value("d"), Value("e"), Value("f")}), Value::array({Value("g"), Value("h"), Value("i")})})}, {"words", Value::array({Value("xyz"), Value("abc"), Value("def")})}})}, {"expected", Value::array({Value("abc"), Value("def")})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"board", Value::array({Value::array({Value("a"), Value("b")}), Value::array({Value("c"), Value("d")})})}, {"words", Value::array({Value("ac"), Value("bd"), Value("ab"), Value("cd")})}})}, {"expected", Value::array({Value("ab"), Value("ac"), Value("bd"), Value("cd")})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"board", Value::array({Value::array({Value("x"), Value("y"), Value("z")}), Value::array({Value("a"), Value("b"), Value("c")})})}, {"words", Value::array({Value("nothere"), Value("missing")})}})}, {"expected", Value::array({})}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"board", "words"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto arg0 = toCharMatrix(raw0);
        Value raw1 = getArg(testObj, argKeys, 1);
        auto arg1 = toStringVector(raw1);
        auto result = sol.findWords(arg0, arg1);
        ...
        if (hasExpectedLength) {
        ...
        } else if ("strings_unordered" == std::string("pair_target_1idx")) {
            ...
            passed = equalValues(gotValue, expected, "strings_unordered");
        }
