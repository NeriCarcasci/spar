...
const TESTS = JSON.parse("[{\"input\":{\"board\":[[\"o\",\"a\",\"a\",\"n\"],[\"e\",\"t\",\"a\",\"e\"],[\"i\",\"h\",\"k\",\"r\"],[\"i\",\"f\",\"l\",\"v\"]],\"words\":[\"oath\",\"pea\",\"eat\",\"rain\"]},\"expected\":[\"eat\",\"oath\"],\"visible\":true},{\"input\":{\"board\":[[\"a\",\"b\"],[\"c\",\"d\"]],\"words\":[\"abcb\"]},\"expected\":[],\"visible\":true},{\"input\":{\"board\":[[\"a\"]],\"words\":[\"a\"]},\"expected\":[\"a\"],\"visible\":false},{\"input\":{\"board\":[[\"a\",\"a\"],[\"a\",\"a\"]],\"words\":[\"aaaa\",\"aaa\",\"aa\",\"a\"]},\"expected\":[\"a\",\"aa\",\"aaa\",\"aaaa\"],\"visible\":false},{\"input\":{\"board\":[[\"a\",\"b\",\"c\"],[\"d\",\"e\",\"f\"],[\"g\",\"h\",\"i\"]],\"words\":[\"xyz\",\"abc\",\"def\"]},\"expected\":[\"abc\",\"def\"],\"visible\":false},{\"input\":{\"board\":[[\"a\",\"b\"],[\"c\",\"d\"]],\"words\":[\"ac\",\"bd\",\"ab\",\"cd\"]},\"expected\":[\"ab\",\"ac\",\"bd\",\"cd\"],\"visible\":false},{\"input\":{\"board\":[[\"x\",\"y\",\"z\"],[\"a\",\"b\",\"c\"]],\"words\":[\"nothere\",\"missing\"]},\"expected\":[],\"visible\":false}]");
const COMPARE_MODE = "strings_unordered";
...
function run(solutionPath, testsPath, challengePath) {
    ...
    const fn = resolveFunction(solution, ["findWords"]);
    const caseInput = test.input;
    let args = [];
    if (isObject(caseInput)) {
        args = ["board", "words"].map((key) => caseInput[key]);
    } else if (Array.isArray(caseInput) && ["board", "words"].length > 1) {
        args.push(caseInput);
        for (let i = 1; i < ["board", "words"].length; i += 1) {
            const key = ["board", "words"][i];
        ...
        args = ["board", "words"].map((key) => test[key]);
    }
    gotValue = fn(...args);
