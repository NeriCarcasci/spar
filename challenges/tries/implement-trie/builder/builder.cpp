...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"operations", Value::array({Value("insert"), Value("search"), Value("search"), Value("starts_with"), Value("insert"), Value("search")})}, {"values", Value::array({Value("apple"), Value("apple"), Value("app"), Value("app"), Value("app"), Value("app")})}})}, {"expected", Value::array({Value(), Value(true), Value(false), Value(true), Value(), Value(true)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("insert"), Value("search"), Value("starts_with")})}, {"values", Value::array({Value("hello"), Value("hello"), Value("hell")})}})}, {"expected", Value::array({Value(), Value(true), Value(true)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("search"), Value("starts_with")})}, {"values", Value::array({Value("empty"), Value("empty")})}})}, {"expected", Value::array({Value(false), Value(false)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("insert"), Value("insert"), Value("search"), Value("search")})}, {"values", Value::array({Value("a"), Value("b"), Value("a"), Value("b")})}})}, {"expected", Value::array({Value(), Value(), Value(true), Value(true)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("insert"), Value("insert"), Value("insert"), Value("starts_with"), Value("starts_with"), Value("search")})}, {"values", Value::array({Value("abc"), Value("ab"), Value("a"), Value("a"), Value("abc"), Value("ab")})}})}, {"expected", Value::array({Value(), Value(), Value(), Value(true), Value(true), Value(true)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("insert"), Value("search"), Value("starts_with"), Value("search")})}, {"values", Value::array({Value("prefix"), Value("prefix"), Value("pre"), Value("pre")})}})}, {"expected", Value::array({Value(), Value(true), Value(true), Value(false)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("insert"), Value("insert"), Value("search"), Value("search"), Value("starts_with")})}, {"values", Value::array({Value("app"), Value("apple"), Value("app"), Value("apple"), Value("appl")})}})}, {"expected", Value::array({Value(), Value(), Value(true), Value(true), Value(true)})}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"operations", "values"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        for (size_t j = 0; j < operations.size(); ++j) {
            ...
            if (op == "insert") {
                ...
                out.push_back(toValue(obj.startsWith(val)));
            } else {
