...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::array({Value(2.0), Value(7.0), Value(11.0), Value(15.0)})}, {"target", Value(9.0)}, {"expected", Value::array({Value(0.0), Value(1.0)})}}),
        Value::object({{"input", Value::array({Value(3.0), Value(2.0), Value(4.0)})}, {"target", Value(6.0)}, {"expected", Value::array({Value(1.0), Value(2.0)})}}),
        Value::object({{"input", Value::array({Value(3.0), Value(3.0)})}, {"target", Value(6.0)}, {"expected", Value::array({Value(0.0), Value(1.0)})}}),
        Value::object({{"input", Value::array({Value(-1.0), Value(-2.0), Value(-3.0), Value(-4.0), Value(-5.0)})}, {"target", Value(-8.0)}, {"expected", Value::array({Value(2.0), Value(4.0)})}}),
        Value::object({{"input", Value::array({Value(1000000000.0), Value(-1000000000.0)})}, {"target", Value(0.0)}, {"expected", Value::array({Value(0.0), Value(1.0)})}}),
        Value::object({{"input", Value::array({Value(0.0), Value(4.0), Value(3.0), Value(0.0)})}, {"target", Value(0.0)}, {"expected", Value::array({Value(0.0), Value(3.0)})}}),
        Value::object({{"input", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0), Value(5.0), Value(6.0), Value(7.0), Value(8.0), Value(9.0), Value(10.0)})}, {"target", Value(19.0)}, {"expected", Value::array({Value(8.0), Value(9.0)})}})
    };
    std::vector<std::string> argKeys = {"nums", "target"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.twoSum(arg0, arg1);
        ...
        if (hasExpectedLength) {
        ...
        } else if ("pair_unordered" == std::string("pair_target_1idx")) {
            ...
            passed = equalValues(gotValue, expected, "pair_unordered");
        }
