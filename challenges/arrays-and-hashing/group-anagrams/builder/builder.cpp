...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"strs", Value::array({Value("eat"), Value("tea"), Value("tan"), Value("ate"), Value("nat"), Value("bat")})}})}, {"expected", Value::array({Value::array({Value("ate"), Value("eat"), Value("tea")}), Value::array({Value("bat")}), Value::array({Value("nat"), Value("tan")})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"strs", Value::array({Value("")})}})}, {"expected", Value::array({Value::array({Value("")})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"strs", Value::array({Value("a")})}})}, {"expected", Value::array({Value::array({Value("a")})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"strs", Value::array({Value("abc"), Value("bca"), Value("cab"), Value("xyz"), Value("zyx")})}})}, {"expected", Value::array({Value::array({Value("abc"), Value("bca"), Value("cab")}), Value::array({Value("xyz"), Value("zyx")})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"strs", Value::array({Value(""), Value("")})}})}, {"expected", Value::array({Value::array({Value(""), Value("")})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"strs", Value::array({Value("listen"), Value("silent"), Value("hello"), Value("world")})}})}, {"expected", Value::array({Value::array({Value("hello")}), Value::array({Value("listen"), Value("silent")}), Value::array({Value("world")})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"strs", Value::array({Value("a"), Value("b"), Value("c"), Value("d")})}})}, {"expected", Value::array({Value::array({Value("a")}), Value::array({Value("b")}), Value::array({Value("c")}), Value::array({Value("d")})})}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"strs"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto arg0 = toStringVector(raw0);
        auto result = sol.groupAnagrams(arg0);
        ...
        if (hasExpectedLength) {
        ...
        } else if ("groups_unordered" == std::string("pair_target_1idx")) {
            ...
            passed = equalValues(gotValue, expected, "groups_unordered");
        }
