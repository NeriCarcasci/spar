...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"strs", Value::array({Value("hello"), Value("world")})}})}, {"expected", Value::array({Value("hello"), Value("world")})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"strs", Value::array({Value("")})}})}, {"expected", Value::array({Value("")})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"strs", Value::array({})}})}, {"expected", Value::array({})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"strs", Value::array({Value("a"), Value("b"), Value("c")})}})}, {"expected", Value::array({Value("a"), Value("b"), Value("c")})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"strs", Value::array({Value("contains:colons"), Value("and#special"), Value("ch@rs!")})}})}, {"expected", Value::array({Value("contains:colons"), Value("and#special"), Value("ch@rs!")})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"strs", Value::array({Value(""), Value(""), Value("")})}})}, {"expected", Value::array({Value(""), Value(""), Value("")})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"strs", Value::array({Value("4#abcd"), Value("3#xyz")})}})}, {"expected", Value::array({Value("4#abcd"), Value("3#xyz")})}, {"visible", Value(false)}})
    };
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        gotValue = toValue(sol.decode(sol.encode(toStringVector(getField(input, "strs")))));
