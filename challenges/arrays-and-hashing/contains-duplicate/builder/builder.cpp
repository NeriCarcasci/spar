...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(1.0)})}})}, {"expected", Value(true)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0)})}})}, {"expected", Value(false)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0)})}})}, {"expected", Value(false)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(1.0)})}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(-1.0), Value(-1.0), Value(0.0), Value(1.0)})}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1000000000.0), Value(-1000000000.0), Value(1000000000.0)})}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0), Value(5.0), Value(6.0), Value(7.0), Value(8.0), Value(9.0), Value(10.0)})}})}, {"expected", Value(false)}, {"visible", Value(false)}})
    };
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.containsDuplicate(arg0);
