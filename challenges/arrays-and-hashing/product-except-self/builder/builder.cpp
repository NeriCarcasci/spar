...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0)})}})}, {"expected", Value::array({Value(24.0), Value(12.0), Value(8.0), Value(6.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(-1.0), Value(1.0), Value(0.0), Value(-3.0), Value(3.0)})}})}, {"expected", Value::array({Value(0.0), Value(0.0), Value(9.0), Value(0.0), Value(0.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(1.0)})}})}, {"expected", Value::array({Value(1.0), Value(1.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(0.0), Value(0.0)})}})}, {"expected", Value::array({Value(0.0), Value(0.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(2.0), Value(3.0), Value(5.0), Value(7.0)})}})}, {"expected", Value::array({Value(105.0), Value(70.0), Value(42.0), Value(30.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(-1.0), Value(-2.0), Value(-3.0)})}})}, {"expected", Value::array({Value(6.0), Value(3.0), Value(2.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(0.0), Value(0.0), Value(1.0)})}})}, {"expected", Value::array({Value(0.0), Value(0.0), Value(0.0), Value(0.0)})}, {"visible", Value(false)}})
    };
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.productExceptSelf(arg0);
