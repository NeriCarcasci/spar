...
const TESTS = JSON.parse("[{\"input\":{\"s\":\"anagram\",\"t\":\"nagaram\"},\"expected\":true,\"visible\":true},{\"input\":{\"s\":\"rat\",\"t\":\"car\"},\"expected\":false,\"visible\":true},{\"input\":{\"s\":\"a\",\"t\":\"a\"},\"expected\":true,\"visible\":false},{\"input\":{\"s\":\"ab\",\"t\":\"a\"},\"expected\":false,\"visible\":false},{\"input\":{\"s\":\"\",\"t\":\"\"},\"expected\":true,\"visible\":false},{\"input\":{\"s\":\"aabbcc\",\"t\":\"abcabc\"},\"expected\":true,\"visible\":false},{\"input\":{\"s\":\"aacc\",\"t\":\"ccac\"},\"expected\":false,\"visible\":false}]");
...
function run(solutionPath, testsPath, challengePath) {
    ...
    const fn = resolveFunction(solution, ["isAnagram"]);
    const caseInput = test.input;
    let args = [];
    if (isObject(caseInput)) {
        args = ["s", "t"].map((key) => caseInput[key]);
    } else if (Array.isArray(caseInput) && ["s", "t"].length > 1) {
        args.push(caseInput);
