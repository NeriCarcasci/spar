...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"s", Value("anagram")}, {"t", Value("nagaram")}})}, {"expected", Value(true)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"s", Value("rat")}, {"t", Value("car")}})}, {"expected", Value(false)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"s", Value("a")}, {"t", Value("a")}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"s", Value("ab")}, {"t", Value("a")}})}, {"expected", Value(false)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"s", Value("")}, {"t", Value("")}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"s", Value("aabbcc")}, {"t", Value("abcabc")}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"s", Value("aacc")}, {"t", Value("ccac")}})}, {"expected", Value(false)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"s", "t"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.isAnagram(arg0, arg1);
