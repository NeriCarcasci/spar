...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"nums", Value::array({Value(-1.0), Value(0.0), Value(1.0), Value(2.0), Value(-1.0), Value(-4.0)})}})}, {"expected", Value::array({Value::array({Value(-1.0), Value(-1.0), Value(2.0)}), Value::array({Value(-1.0), Value(0.0), Value(1.0)})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(0.0), Value(1.0), Value(1.0)})}})}, {"expected", Value::array({})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(0.0), Value(0.0), Value(0.0)})}})}, {"expected", Value::array({Value::array({Value(0.0), Value(0.0), Value(0.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(0.0), Value(0.0), Value(0.0), Value(0.0)})}})}, {"expected", Value::array({Value::array({Value(0.0), Value(0.0), Value(0.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(-2.0), Value(0.0), Value(1.0), Value(1.0), Value(2.0)})}})}, {"expected", Value::array({Value::array({Value(-2.0), Value(0.0), Value(2.0)}), Value::array({Value(-2.0), Value(1.0), Value(1.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(2.0), Value(-2.0), Value(-1.0)})}})}, {"expected", Value::array({})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(-1.0), Value(-1.0), Value(-1.0), Value(2.0)})}})}, {"expected", Value::array({Value::array({Value(-1.0), Value(-1.0), Value(2.0)})})}, {"visible", Value(false)}})
    };
