...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"numbers", Value::array({Value(2.0), Value(7.0), Value(11.0), Value(15.0)})}, {"target", Value(9.0)}})}, {"expected", Value::array({Value(1.0), Value(2.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"numbers", Value::array({Value(2.0), Value(3.0), Value(4.0)})}, {"target", Value(6.0)}})}, {"expected", Value::array({Value(1.0), Value(3.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"numbers", Value::array({Value(-1.0), Value(0.0)})}, {"target", Value(-1.0)}})}, {"expected", Value::array({Value(1.0), Value(2.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"numbers", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0), Value(5.0)})}, {"target", Value(9.0)}})}, {"expected", Value::array({Value(4.0), Value(5.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"numbers", Value::array({Value(-3.0), Value(-1.0), Value(0.0), Value(1.0), Value(5.0), Value(8.0)})}, {"target", Value(4.0)}})}, {"expected", Value::array({Value(2.0), Value(6.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"numbers", Value::array({Value(1.0), Value(1.0), Value(1.0), Value(1.0), Value(4.0)})}, {"target", Value(5.0)}})}, {"expected", Value::array({Value(1.0), Value(5.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"numbers", Value::array({Value(-1000.0), Value(-1.0), Value(0.0), Value(1.0), Value(1000.0)})}, {"target", Value(0.0)}})}, {"expected", Value::array({Value(1.0), Value(5.0)})}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"numbers", "target"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.twoSumSorted(arg0, arg1);
        ...
        if (hasExpectedLength) {
        ...
        } else if ("pair_target_1idx" == std::string("pair_target_1idx")) {
            ...
            passed = equalValues(gotValue, expected, "pair_target_1idx");
        }
