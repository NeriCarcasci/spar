...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"height", Value::array({Value(0.0), Value(1.0), Value(0.0), Value(2.0), Value(1.0), Value(0.0), Value(1.0), Value(3.0), Value(2.0), Value(1.0), Value(2.0), Value(1.0)})}})}, {"expected", Value(6.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"height", Value::array({Value(4.0), Value(2.0), Value(0.0), Value(3.0), Value(2.0), Value(5.0)})}})}, {"expected", Value(9.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"height", Value::array({Value(1.0)})}})}, {"expected", Value(0.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"height", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0), Value(5.0)})}})}, {"expected", Value(0.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"height", Value::array({Value(5.0), Value(4.0), Value(3.0), Value(2.0), Value(1.0)})}})}, {"expected", Value(0.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"height", Value::array({Value(3.0), Value(0.0), Value(0.0), Value(0.0), Value(3.0)})}})}, {"expected", Value(9.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"height", Value::array({Value(0.0), Value(0.0), Value(0.0)})}})}, {"expected", Value(0.0)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"height"};
    bool failed = false;
