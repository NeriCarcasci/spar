...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"height", Value::array({Value(1.0), Value(8.0), Value(6.0), Value(2.0), Value(5.0), Value(4.0), Value(8.0), Value(3.0), Value(7.0)})}})}, {"expected", Value(49.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"height", Value::array({Value(1.0), Value(1.0)})}})}, {"expected", Value(1.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"height", Value::array({Value(4.0), Value(3.0), Value(2.0), Value(1.0), Value(4.0)})}})}, {"expected", Value(16.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"height", Value::array({Value(1.0), Value(2.0), Value(1.0)})}})}, {"expected", Value(2.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"height", Value::array({Value(0.0), Value(0.0)})}})}, {"expected", Value(0.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"height", Value::array({Value(10000.0), Value(10000.0)})}})}, {"expected", Value(10000.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"height", Value::array({Value(1.0), Value(2.0), Value(4.0), Value(3.0)})}})}, {"expected", Value(4.0)}, {"visible", Value(false)}})
    };
