...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"piles", Value::array({Value(3.0), Value(6.0), Value(7.0), Value(11.0)})}, {"h", Value(8.0)}})}, {"expected", Value(4.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"piles", Value::array({Value(30.0), Value(11.0), Value(23.0), Value(4.0), Value(20.0)})}, {"h", Value(5.0)}})}, {"expected", Value(30.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"piles", Value::array({Value(1.0)})}, {"h", Value(1.0)}})}, {"expected", Value(1.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"piles", Value::array({Value(1000000000.0)})}, {"h", Value(2.0)}})}, {"expected", Value(500000000.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"piles", Value::array({Value(30.0), Value(11.0), Value(23.0), Value(4.0), Value(20.0)})}, {"h", Value(6.0)}})}, {"expected", Value(23.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"piles", Value::array({Value(1.0), Value(1.0), Value(1.0), Value(1.0)})}, {"h", Value(4.0)}})}, {"expected", Value(1.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"piles", Value::array({Value(312884470.0)})}, {"h", Value(968709470.0)}})}, {"expected", Value(1.0)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"piles", "h"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.minEatingSpeed(arg0, arg1);
