...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"nums1", Value::array({Value(1.0), Value(3.0)})}, {"nums2", Value::array({Value(2.0)})}})}, {"expected", Value(2.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums1", Value::array({Value(1.0), Value(2.0)})}, {"nums2", Value::array({Value(3.0), Value(4.0)})}})}, {"expected", Value(2.5)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums1", Value::array({})}, {"nums2", Value::array({Value(1.0)})}})}, {"expected", Value(1.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums1", Value::array({Value(2.0)})}, {"nums2", Value::array({})}})}, {"expected", Value(2.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums1", Value::array({Value(1.0), Value(2.0), Value(3.0)})}, {"nums2", Value::array({Value(4.0), Value(5.0), Value(6.0)})}})}, {"expected", Value(3.5)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums1", Value::array({Value(1.0)})}, {"nums2", Value::array({Value(1.0)})}})}, {"expected", Value(1.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums1", Value::array({Value(1.0), Value(3.0), Value(5.0), Value(7.0)})}, {"nums2", Value::array({Value(2.0), Value(4.0), Value(6.0), Value(8.0)})}})}, {"expected", Value(4.5)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"nums1", "nums2"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto arg1 = toIntVector(raw1);
        auto result = sol.findMedianSortedArrays(arg0, arg1);
