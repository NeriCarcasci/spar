...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"nums", Value::array({Value(3.0), Value(4.0), Value(5.0), Value(1.0), Value(2.0)})}})}, {"expected", Value(1.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(4.0), Value(5.0), Value(6.0), Value(7.0), Value(0.0), Value(1.0), Value(2.0)})}})}, {"expected", Value(0.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0)})}})}, {"expected", Value(1.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(2.0), Value(1.0)})}})}, {"expected", Value(1.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0), Value(5.0)})}})}, {"expected", Value(1.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(11.0), Value(13.0), Value(15.0), Value(17.0)})}})}, {"expected", Value(11.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(5000.0), Value(-5000.0)})}})}, {"expected", Value(-5000.0)}, {"visible", Value(false)}})
    };
