...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"nums", Value::array({Value(-1.0), Value(0.0), Value(3.0), Value(5.0), Value(9.0), Value(12.0)})}, {"target", Value(9.0)}})}, {"expected", Value(4.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(-1.0), Value(0.0), Value(3.0), Value(5.0), Value(9.0), Value(12.0)})}, {"target", Value(2.0)}})}, {"expected", Value(-1.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(5.0)})}, {"target", Value(5.0)}})}, {"expected", Value(0.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0)})}, {"target", Value(2.0)}})}, {"expected", Value(-1.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0), Value(5.0)})}, {"target", Value(1.0)}})}, {"expected", Value(0.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0), Value(5.0)})}, {"target", Value(5.0)}})}, {"expected", Value(4.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(-9999.0), Value(0.0), Value(9999.0)})}, {"target", Value(-9999.0)}})}, {"expected", Value(0.0)}, {"visible", Value(false)}})
    };
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.search(arg0, arg1);
