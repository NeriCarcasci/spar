...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"tasks", Value::array({Value("A"), Value("A"), Value("A"), Value("B"), Value("B"), Value("B")})}, {"n", Value(2.0)}})}, {"expected", Value(8.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"tasks", Value::array({Value("A"), Value("A"), Value("A"), Value("B"), Value("B"), Value("B")})}, {"n", Value(0.0)}})}, {"expected", Value(6.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"tasks", Value::array({Value("A"), Value("A"), Value("A"), Value("A"), Value("A"), Value("A"), Value("B"), Value("C"), Value("D"), Value("E"), Value("F"), Value("G")})}, {"n", Value(2.0)}})}, {"expected", Value(16.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"tasks", Value::array({Value("A")})}, {"n", Value(5.0)}})}, {"expected", Value(1.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"tasks", Value::array({Value("A"), Value("B"), Value("C"), Value("D"), Value("E"), Value("F")})}, {"n", Value(2.0)}})}, {"expected", Value(6.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"tasks", Value::array({Value("A"), Value("A"), Value("A"), Value("B"), Value("B"), Value("B"), Value("C"), Value("C"), Value("C")})}, {"n", Value(2.0)}})}, {"expected", Value(9.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"tasks", Value::array({Value("A"), Value("A"), Value("B"), Value("B"), Value("C"), Value("C")})}, {"n", Value(1.0)}})}, {"expected", Value(6.0)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"tasks", "n"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto arg0 = toCharVector(raw0);
        Value raw1 = getArg(testObj, argKeys, 1);
        auto arg1 = toInt(raw1);
        auto result = sol.leastInterval(arg0, arg1);
