...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"k", Value(3.0)}, {"nums", Value::array({Value(4.0), Value(5.0), Value(8.0), Value(2.0)})}, {"operations", Value::array({Value("add"), Value("add"), Value("add"), Value("add"), Value("add")})}, {"values", Value::array({Value(3.0), Value(5.0), Value(10.0), Value(9.0), Value(4.0)})}})}, {"expected", Value::array({Value(4.0), Value(5.0), Value(5.0), Value(8.0), Value(8.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"k", Value(1.0)}, {"nums", Value::array({})}, {"operations", Value::array({Value("add"), Value("add"), Value("add")})}, {"values", Value::array({Value(1.0), Value(2.0), Value(3.0)})}})}, {"expected", Value::array({Value(1.0), Value(2.0), Value(3.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"k", Value(2.0)}, {"nums", Value::array({Value(0.0)})}, {"operations", Value::array({Value("add"), Value("add"), Value("add")})}, {"values", Value::array({Value(-1.0), Value(1.0), Value(-2.0)})}})}, {"expected", Value::array({Value(-1.0), Value(0.0), Value(0.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"k", Value(1.0)}, {"nums", Value::array({Value(5.0)})}, {"operations", Value::array({Value("add"), Value("add")})}, {"values", Value::array({Value(3.0), Value(7.0)})}})}, {"expected", Value::array({Value(5.0), Value(7.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"k", Value(3.0)}, {"nums", Value::array({Value(1.0), Value(1.0), Value(1.0)})}, {"operations", Value::array({Value("add"), Value("add")})}, {"values", Value::array({Value(1.0), Value(1.0)})}})}, {"expected", Value::array({Value(1.0), Value(1.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"k", Value(4.0)}, {"nums", Value::array({Value(7.0), Value(7.0), Value(7.0), Value(7.0), Value(8.0), Value(3.0)})}, {"operations", Value::array({Value("add"), Value("add")})}, {"values", Value::array({Value(2.0), Value(10.0)})}})}, {"expected", Value::array({Value(7.0), Value(7.0)})}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"k", "nums", "operations", "values"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        for (size_t j = 0; j < operations.size(); ++j) {
            ...
            out.push_back(toValue(obj.add(toInt(val))));
        }
        gotValue = Value(out);
