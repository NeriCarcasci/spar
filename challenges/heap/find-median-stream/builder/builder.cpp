...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"operations", Value::array({Value("add_num"), Value("add_num"), Value("find_median"), Value("add_num"), Value("find_median")})}, {"values", Value::array({Value(1.0), Value(2.0), Value(), Value(3.0), Value()})}})}, {"expected", Value::array({Value(), Value(), Value(1.5), Value(), Value(2.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("add_num"), Value("find_median")})}, {"values", Value::array({Value(5.0), Value()})}})}, {"expected", Value::array({Value(), Value(5.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("add_num"), Value("add_num"), Value("add_num"), Value("add_num"), Value("find_median")})}, {"values", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0), Value()})}})}, {"expected", Value::array({Value(), Value(), Value(), Value(), Value(2.5)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("add_num"), Value("add_num"), Value("find_median"), Value("add_num"), Value("find_median")})}, {"values", Value::array({Value(-1.0), Value(-2.0), Value(), Value(-3.0), Value()})}})}, {"expected", Value::array({Value(), Value(), Value(-1.5), Value(), Value(-2.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("add_num"), Value("add_num"), Value("add_num"), Value("find_median")})}, {"values", Value::array({Value(5.0), Value(5.0), Value(5.0), Value()})}})}, {"expected", Value::array({Value(), Value(), Value(), Value(5.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"operations", Value::array({Value("add_num"), Value("find_median"), Value("add_num"), Value("find_median"), Value("add_num"), Value("find_median")})}, {"values", Value::array({Value(10.0), Value(), Value(20.0), Value(), Value(30.0), Value()})}})}, {"expected", Value::array({Value(), Value(10.0), Value(), Value(15.0), Value(), Value(20.0)})}, {"visible", Value(false)}})
    };
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        for (size_t j = 0; j < operations.size(); ++j) {
            ...
            if (op == "add_num") {
                obj.addNum(toInt(val));
                out.push_back(Value());
            } else if (op == "find_median") {
                out.push_back(toValue(obj.findMedian()));
            } else {
        ...
        if (hasExpectedLength) {
        ...
        } else if ("float_sequence" == std::string("pair_target_1idx")) {
            Value::Object input = asObject(getField(testObj, "input"));
            ...
            passed = equalValues(gotValue, expected, "float_sequence");
        }
