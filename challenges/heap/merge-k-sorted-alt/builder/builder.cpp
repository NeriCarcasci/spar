...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"points", Value::array({Value::array({Value(1.0), Value(3.0)}), Value::array({Value(-2.0), Value(2.0)})})}, {"k", Value(1.0)}})}, {"expected", Value::array({Value::array({Value(-2.0), Value(2.0)})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"points", Value::array({Value::array({Value(3.0), Value(3.0)}), Value::array({Value(5.0), Value(-1.0)}), Value::array({Value(-2.0), Value(4.0)})})}, {"k", Value(2.0)}})}, {"expected", Value::array({Value::array({Value(-2.0), Value(4.0)}), Value::array({Value(3.0), Value(3.0)})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"points", Value::array({Value::array({Value(0.0), Value(0.0)})})}, {"k", Value(1.0)}})}, {"expected", Value::array({Value::array({Value(0.0), Value(0.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"points", Value::array({Value::array({Value(1.0), Value(1.0)}), Value::array({Value(-1.0), Value(-1.0)}), Value::array({Value(2.0), Value(2.0)})})}, {"k", Value(2.0)}})}, {"expected", Value::array({Value::array({Value(-1.0), Value(-1.0)}), Value::array({Value(1.0), Value(1.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"points", Value::array({Value::array({Value(1.0), Value(0.0)}), Value::array({Value(0.0), Value(1.0)}), Value::array({Value(-1.0), Value(0.0)}), Value::array({Value(0.0), Value(-1.0)})})}, {"k", Value(4.0)}})}, {"expected", Value::array({Value::array({Value(-1.0), Value(0.0)}), Value::array({Value(0.0), Value(-1.0)}), Value::array({Value(0.0), Value(1.0)}), Value::array({Value(1.0), Value(0.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"points", Value::array({Value::array({Value(10.0), Value(10.0)}), Value::array({Value(5.0), Value(5.0)}), Value::array({Value(1.0), Value(1.0)}), Value::array({Value(3.0), Value(3.0)})})}, {"k", Value(3.0)}})}, {"expected", Value::array({Value::array({Value(1.0), Value(1.0)}), Value::array({Value(3.0), Value(3.0)}), Value::array({Value(5.0), Value(5.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"points", Value::array({Value::array({Value(2.0), Value(3.0)}), Value::array({Value(4.0), Value(0.0)}), Value::array({Value(0.0), Value(4.0)})})}, {"k", Value(2.0)}})}, {"expected", Value::array({Value::array({Value(2.0), Value(3.0)}), Value::array({Value(0.0), Value(4.0)})})}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"points", "k"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        Value raw1 = getArg(testObj, argKeys, 1);
        auto arg1 = toInt(raw1);
        auto result = sol.kClosest(arg0, arg1);
