...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"root", Value::array({Value(3.0), Value(4.0), Value(5.0), Value(1.0), Value(2.0)})}, {"subRoot", Value::array({Value(4.0), Value(1.0), Value(2.0)})}})}, {"expected", Value(true)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(3.0), Value(4.0), Value(5.0), Value(1.0), Value(2.0), Value(), Value(), Value(), Value(), Value(0.0)})}, {"subRoot", Value::array({Value(4.0), Value(1.0), Value(2.0)})}})}, {"expected", Value(false)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(1.0)})}, {"subRoot", Value::array({Value(1.0)})}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(1.0), Value(2.0), Value(3.0)})}, {"subRoot", Value::array({Value(2.0)})}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(1.0), Value(), Value(2.0)})}, {"subRoot", Value::array({Value(2.0)})}})}, {"expected", Value(true)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"root", "subRoot"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto arg1 = buildTree(raw1);
        auto result = sol.isSubtree(arg0, arg1);
