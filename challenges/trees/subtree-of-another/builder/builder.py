...
def run(solution_path, tests_path, challenge_path):
    ...
    for idx, case in enumerate(TESTS, start=1):
        ...
        fn = resolve_callable(module, ['is_subtree'])
        ...
        for key in ['root', 'subRoot']:
            ...
            args.append(value)
        out = fn(*args)
        if 'trees/subtree-of-another' in ("trees/build-tree-preorder", "trees/invert-binary-tree"):
