...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"root", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(), Value(), Value(4.0), Value(5.0)})}})}, {"expected", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(), Value(), Value(4.0), Value(5.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"root", Value::array({})}})}, {"expected", Value::array({})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(1.0)})}})}, {"expected", Value::array({Value(1.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(1.0), Value(2.0), Value(), Value(3.0)})}})}, {"expected", Value::array({Value(1.0), Value(2.0), Value(), Value(3.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0), Value(5.0), Value(6.0), Value(7.0)})}})}, {"expected", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0), Value(5.0), Value(6.0), Value(7.0)})}, {"visible", Value(false)}})
    };
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        gotValue = treeToValue(sol.deserialize(sol.serialize(root)));
