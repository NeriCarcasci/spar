...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"root", Value::array({Value(6.0), Value(2.0), Value(8.0), Value(0.0), Value(4.0), Value(7.0), Value(9.0), Value(), Value(), Value(3.0), Value(5.0)})}, {"p", Value(2.0)}, {"q", Value(8.0)}})}, {"expected", Value(6.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(6.0), Value(2.0), Value(8.0), Value(0.0), Value(4.0), Value(7.0), Value(9.0), Value(), Value(), Value(3.0), Value(5.0)})}, {"p", Value(2.0)}, {"q", Value(4.0)}})}, {"expected", Value(2.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(2.0), Value(1.0)})}, {"p", Value(2.0)}, {"q", Value(1.0)}})}, {"expected", Value(2.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(6.0), Value(2.0), Value(8.0)})}, {"p", Value(2.0)}, {"q", Value(8.0)}})}, {"expected", Value(6.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(3.0), Value(1.0), Value(5.0), Value(0.0), Value(2.0), Value(4.0), Value(6.0)})}, {"p", Value(0.0)}, {"q", Value(2.0)}})}, {"expected", Value(1.0)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"root", "p", "q"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        gotValue = toValue(sol.lowestCommonAncestor(buildTree(getField(input, "root")), toInt(getField(input, "p")), toInt(getField(input, "q"))));
