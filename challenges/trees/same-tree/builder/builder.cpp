...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"p", Value::array({Value(1.0), Value(2.0), Value(3.0)})}, {"q", Value::array({Value(1.0), Value(2.0), Value(3.0)})}})}, {"expected", Value(true)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"p", Value::array({Value(1.0), Value(2.0)})}, {"q", Value::array({Value(1.0), Value(), Value(2.0)})}})}, {"expected", Value(false)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"p", Value::array({})}, {"q", Value::array({})}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"p", Value::array({Value(1.0)})}, {"q", Value::array({Value(1.0)})}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"p", Value::array({Value(1.0), Value(2.0)})}, {"q", Value::array({Value(1.0), Value(2.0), Value(3.0)})}})}, {"expected", Value(false)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"p", "q"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.isSameTree(arg0, arg1);
