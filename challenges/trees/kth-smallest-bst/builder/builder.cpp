...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"root", Value::array({Value(3.0), Value(1.0), Value(4.0), Value(), Value(2.0)})}, {"k", Value(1.0)}})}, {"expected", Value(1.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(5.0), Value(3.0), Value(6.0), Value(2.0), Value(4.0), Value(), Value(), Value(1.0)})}, {"k", Value(3.0)}})}, {"expected", Value(3.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(1.0)})}, {"k", Value(1.0)}})}, {"expected", Value(1.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(2.0), Value(1.0), Value(3.0)})}, {"k", Value(2.0)}})}, {"expected", Value(2.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(2.0), Value(1.0), Value(3.0)})}, {"k", Value(3.0)}})}, {"expected", Value(3.0)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"root", "k"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.kthSmallest(arg0, arg1);
