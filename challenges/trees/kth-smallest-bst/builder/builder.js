...
const TESTS = JSON.parse("[{\"input\":{\"root\":[3,1,4,null,2],\"k\":1},\"expected\":1,\"visible\":true},{\"input\":{\"root\":[5,3,6,2,4,null,null,1],\"k\":3},\"expected\":3,\"visible\":true},{\"input\":{\"root\":[1],\"k\":1},\"expected\":1,\"visible\":false},{\"input\":{\"root\":[2,1,3],\"k\":2},\"expected\":2,\"visible\":false},{\"input\":{\"root\":[2,1,3],\"k\":3},\"expected\":3,\"visible\":false}]");
...
function run(solutionPath, testsPath, challengePath) {
    ...
    const out = fn(...args);
    if ("trees/kth-smallest-bst" === "trees/build-tree-preorder" || "trees/kth-smallest-bst" === "trees/invert-binary-tree") {
