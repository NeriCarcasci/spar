...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"root", Value::array({Value(1.0), Value(2.0), Value(3.0)})}})}, {"expected", Value(6.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(-10.0), Value(9.0), Value(20.0), Value(), Value(), Value(15.0), Value(7.0)})}})}, {"expected", Value(42.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(1.0)})}})}, {"expected", Value(1.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(-3.0)})}})}, {"expected", Value(-3.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"root", Value::array({Value(2.0), Value(-1.0), Value(-2.0)})}})}, {"expected", Value(2.0)}, {"visible", Value(false)}})
    };
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.maxPathSum(arg0);
