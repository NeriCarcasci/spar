...
const TESTS = JSON.parse("[{\"input\":{\"root\":[4,2,7,1,3,6,9]},\"expected\":[4,7,2,9,6,3,1],\"visible\":true},{\"input\":{\"root\":[2,1,3]},\"expected\":[2,3,1],\"visible\":true},{\"input\":{\"root\":[]},\"expected\":[],\"visible\":false},{\"input\":{\"root\":[1]},\"expected\":[1],\"visible\":false},{\"input\":{\"root\":[1,2,null]},\"expected\":[1,null,2],\"visible\":false}]");
...
function run(solutionPath, testsPath, challengePath) {
    ...
    const fn = resolveFunction(solution, ["invertTree"]);
    ...
    const out = fn(...args);
    if ("trees/invert-binary-tree" === "trees/build-tree-preorder" || "trees/invert-binary-tree" === "trees/invert-binary-tree") {
