...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(3.0), Value(-1.0), Value(-3.0), Value(5.0), Value(3.0), Value(6.0), Value(7.0)})}, {"k", Value(3.0)}})}, {"expected", Value::array({Value(3.0), Value(3.0), Value(5.0), Value(5.0), Value(6.0), Value(7.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0)})}, {"k", Value(1.0)}})}, {"expected", Value::array({Value(1.0)})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(-1.0)})}, {"k", Value(1.0)}})}, {"expected", Value::array({Value(1.0), Value(-1.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(7.0), Value(2.0), Value(4.0)})}, {"k", Value(2.0)}})}, {"expected", Value::array({Value(7.0), Value(4.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0), Value(5.0)})}, {"k", Value(5.0)}})}, {"expected", Value::array({Value(5.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(5.0), Value(4.0), Value(3.0), Value(2.0), Value(1.0)})}, {"k", Value(3.0)}})}, {"expected", Value::array({Value(5.0), Value(4.0), Value(3.0)})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"nums", Value::array({Value(-1.0), Value(-2.0), Value(-3.0), Value(-4.0)})}, {"k", Value(2.0)}})}, {"expected", Value::array({Value(-1.0), Value(-2.0), Value(-3.0)})}, {"visible", Value(false)}})
    };
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.maxSlidingWindow(arg0, arg1);
