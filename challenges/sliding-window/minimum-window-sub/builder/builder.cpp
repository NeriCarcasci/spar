...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"s", Value("ADOBECODEBANC")}, {"t", Value("ABC")}})}, {"expected", Value("BANC")}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"s", Value("a")}, {"t", Value("a")}})}, {"expected", Value("a")}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"s", Value("a")}, {"t", Value("aa")}})}, {"expected", Value("")}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"s", Value("a")}, {"t", Value("b")}})}, {"expected", Value("")}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"s", Value("abc")}, {"t", Value("abc")}})}, {"expected", Value("abc")}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"s", Value("aaaaaaaaab")}, {"t", Value("ab")}})}, {"expected", Value("ab")}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"s", Value("cabwefgewcwaefgcf")}, {"t", Value("cae")}})}, {"expected", Value("cwae")}, {"visible", Value(false)}})
    };
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.minWindow(arg0, arg1);
