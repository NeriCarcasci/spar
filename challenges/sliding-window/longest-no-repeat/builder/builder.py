...
TESTS = json.loads('[{"input":{"s":"abcabcbb"},"expected":3,"visible":true},{"input":{"s":"bbbbb"},"expected":1,"visible":true},{"input":{"s":""},"expected":0,"visible":false},{"input":{"s":"a"},"expected":1,"visible":false},{"input":{"s":"pwwkew"},"expected":3,"visible":false},{"input":{"s":"abcdefg"},"expected":7,"visible":false},{"input":{"s":"aab"},"expected":2,"visible":false}]')
COMPARE_MODE = 'exact'
...
def run(solution_path, tests_path, challenge_path):
    ...
    for idx, case in enumerate(TESTS, start=1):
        ...
        fn = resolve_callable(module, ['length_of_longest_substring'])
