...
TESTS = json.loads('[{"input":[[1,4,5],[1,3,4],[2,6]],"expected":[1,1,2,3,4,4,5,6]},{"input":[],"expected":[]},{"input":[[]],"expected":[]},{"input":[[1],[2],[3]],"expected":[1,2,3]},{"input":[[-1,1],[-3,-1,-1,0]],"expected":[-3,-1,-1,-1,0,1]},{"input":[[1,2,3],[4,5,6],[7,8,9]],"expected":[1,2,3,4,5,6,7,8,9]}]')
COMPARE_MODE = 'exact'
...
def run(solution_path, tests_path, challenge_path):
    ...
    for idx, case in enumerate(TESTS, start=1):
        ...
        fn = resolve_callable(module, ['merge_k_lists'])
