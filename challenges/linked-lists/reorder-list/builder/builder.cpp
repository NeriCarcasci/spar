...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0)})}, {"expected", Value::array({Value(1.0), Value(4.0), Value(2.0), Value(3.0)})}}),
        Value::object({{"input", Value::array({Value(1.0), Value(2.0), Value(3.0), Value(4.0), Value(5.0)})}, {"expected", Value::array({Value(1.0), Value(5.0), Value(2.0), Value(4.0), Value(3.0)})}}),
        Value::object({{"input", Value::array({Value(1.0)})}, {"expected", Value::array({Value(1.0)})}}),
        Value::object({{"input", Value::array({Value(1.0), Value(2.0)})}, {"expected", Value::array({Value(1.0), Value(2.0)})}}),
        Value::object({{"input", Value::array({Value(1.0), Value(2.0), Value(3.0)})}, {"expected", Value::array({Value(1.0), Value(3.0), Value(2.0)})}})
    };
