...
TESTS = json.loads('[{"input":[1,2,3,4],"expected":[1,4,2,3]},{"input":[1,2,3,4,5],"expected":[1,5,2,4,3]},{"input":[1],"expected":[1]},{"input":[1,2],"expected":[1,2]},{"input":[1,2,3],"expected":[1,3,2]}]')
COMPARE_MODE = 'exact'
...
def run(solution_path, tests_path, challenge_path):
    ...
    for idx, case in enumerate(TESTS, start=1):
        ...
        fn = resolve_callable(module, ['reorder_list'])
