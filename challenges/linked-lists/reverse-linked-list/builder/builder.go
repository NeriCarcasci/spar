...
const testsJSON = "[{\"input\":[1,2,3,4,5],\"expected\":[5,4,3,2,1]},{\"input\":[1,2],\"expected\":[2,1]},{\"input\":[],\"expected\":[]},{\"input\":[1],\"expected\":[1]},{\"input\":[1,2,3],\"expected\":[3,2,1]},{\"input\":[5,4,3,2,1],\"expected\":[1,2,3,4,5]}]"
...
func main() {
    ...
    for i, test := range tests {
        ...
        gotValue = normalizeValue(listToAny(reverseList(buildList(test["input"]))))
