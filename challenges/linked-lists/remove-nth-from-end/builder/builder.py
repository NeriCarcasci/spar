...
TESTS = json.loads('[{"input":{"list":[1,2,3,4,5],"n":2},"expected":[1,2,3,5]},{"input":{"list":[1],"n":1},"expected":[]},{"input":{"list":[1,2],"n":1},"expected":[1]},{"input":{"list":[1,2],"n":2},"expected":[2]},{"input":{"list":[1,2,3],"n":3},"expected":[2,3]},{"input":{"list":[1,2,3,4,5],"n":5},"expected":[2,3,4,5]}]')
COMPARE_MODE = 'exact'
...
def run(solution_path, tests_path, challenge_path):
    ...
    for idx, case in enumerate(TESTS, start=1):
        ...
        fn = resolve_callable(module, ['remove_nth_from_end'])
