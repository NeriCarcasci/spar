...
const testsJSON = "[{\"input\":{\"list\":[1,2,3,4,5],\"n\":2},\"expected\":[1,2,3,5]},{\"input\":{\"list\":[1],\"n\":1},\"expected\":[]},{\"input\":{\"list\":[1,2],\"n\":1},\"expected\":[1]},{\"input\":{\"list\":[1,2],\"n\":2},\"expected\":[2]},{\"input\":{\"list\":[1,2,3],\"n\":3},\"expected\":[2,3]},{\"input\":{\"list\":[1,2,3,4,5],\"n\":5},\"expected\":[2,3,4,5]}]"
...
func main() {
    ...
    for i, test := range tests {
        ...
        gotValue = normalizeValue(listToAny(removeNthFromEnd(buildList(inp["list"]), toInt(inp["n"]))))
