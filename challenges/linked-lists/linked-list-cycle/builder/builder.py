...
TESTS = json.loads('[{"input":{"list":[3,2,0,-4],"pos":1},"expected":true},{"input":{"list":[1,2],"pos":0},"expected":true},{"input":{"list":[1],"pos":-1},"expected":false},{"input":{"list":[],"pos":-1},"expected":false},{"input":{"list":[1,2,3,4],"pos":-1},"expected":false},{"input":{"list":[1,2,3,4],"pos":2},"expected":true}]')
COMPARE_MODE = 'exact'
...
def run(solution_path, tests_path, challenge_path):
    ...
    for idx, case in enumerate(TESTS, start=1):
        ...
        fn = resolve_callable(module, ['has_cycle'])
