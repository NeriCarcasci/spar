...
const testsJSON = "[{\"input\":{\"list\":[3,2,0,-4],\"pos\":1},\"expected\":true},{\"input\":{\"list\":[1,2],\"pos\":0},\"expected\":true},{\"input\":{\"list\":[1],\"pos\":-1},\"expected\":false},{\"input\":{\"list\":[],\"pos\":-1},\"expected\":false},{\"input\":{\"list\":[1,2,3,4],\"pos\":-1},\"expected\":false},{\"input\":{\"list\":[1,2,3,4],\"pos\":2},\"expected\":true}]"
...
func main() {
    ...
    for i, test := range tests {
        ...
        gotValue = normalizeValue(hasCycle(head))
