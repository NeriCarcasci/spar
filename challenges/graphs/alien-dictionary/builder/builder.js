...
const TESTS = JSON.parse("[{\"input\":{\"words\":[\"wrt\",\"wrf\",\"er\",\"ett\",\"rftt\"]},\"expected\":\"wertf\",\"visible\":true},{\"input\":{\"words\":[\"z\",\"x\"]},\"expected\":\"zx\",\"visible\":true},{\"input\":{\"words\":[\"z\",\"x\",\"z\"]},\"expected\":\"\",\"visible\":false},{\"input\":{\"words\":[\"abc\",\"ab\"]},\"expected\":\"\",\"visible\":false},{\"input\":{\"words\":[\"z\"]},\"expected\":\"z\",\"visible\":false},{\"input\":{\"words\":[\"a\",\"b\",\"ca\",\"cc\"]},\"expected\":\"abc\",\"visible\":false},{\"input\":{\"words\":[\"ab\",\"abc\"]},\"expected\":\"abc\",\"visible\":false}]");
...
function run(solutionPath, testsPath, challengePath) {
    ...
    const fn = resolveFunction(solution, ["alienOrder"]);
    const caseInput = test.input;
    let args = [];
    if (isObject(caseInput)) {
        args = ["words"].map((key) => caseInput[key]);
    } else if (Array.isArray(caseInput) && ["words"].length > 1) {
        args.push(caseInput);
