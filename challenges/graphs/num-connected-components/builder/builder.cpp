...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"n", Value(5.0)}, {"edges", Value::array({Value::array({Value(0.0), Value(1.0)}), Value::array({Value(1.0), Value(2.0)}), Value::array({Value(3.0), Value(4.0)})})}})}, {"expected", Value(2.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"n", Value(5.0)}, {"edges", Value::array({Value::array({Value(0.0), Value(1.0)}), Value::array({Value(1.0), Value(2.0)}), Value::array({Value(2.0), Value(3.0)}), Value::array({Value(3.0), Value(4.0)})})}})}, {"expected", Value(1.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"n", Value(1.0)}, {"edges", Value::array({})}})}, {"expected", Value(1.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"n", Value(5.0)}, {"edges", Value::array({})}})}, {"expected", Value(5.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"n", Value(4.0)}, {"edges", Value::array({Value::array({Value(0.0), Value(1.0)}), Value::array({Value(2.0), Value(3.0)})})}})}, {"expected", Value(2.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"n", Value(6.0)}, {"edges", Value::array({Value::array({Value(0.0), Value(1.0)}), Value::array({Value(0.0), Value(2.0)}), Value::array({Value(3.0), Value(4.0)}), Value::array({Value(3.0), Value(5.0)}), Value::array({Value(4.0), Value(5.0)})})}})}, {"expected", Value(2.0)}, {"visible", Value(false)}})
    };
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.countComponents(arg0, arg1);
