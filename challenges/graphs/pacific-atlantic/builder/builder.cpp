...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"heights", Value::array({Value::array({Value(1.0), Value(2.0), Value(2.0), Value(3.0), Value(5.0)}), Value::array({Value(3.0), Value(2.0), Value(3.0), Value(4.0), Value(4.0)}), Value::array({Value(2.0), Value(4.0), Value(5.0), Value(3.0), Value(1.0)}), Value::array({Value(6.0), Value(7.0), Value(1.0), Value(4.0), Value(5.0)}), Value::array({Value(5.0), Value(1.0), Value(1.0), Value(2.0), Value(4.0)})})}})}, {"expected", Value::array({Value::array({Value(0.0), Value(4.0)}), Value::array({Value(1.0), Value(3.0)}), Value::array({Value(1.0), Value(4.0)}), Value::array({Value(2.0), Value(2.0)}), Value::array({Value(3.0), Value(0.0)}), Value::array({Value(3.0), Value(1.0)}), Value::array({Value(4.0), Value(0.0)})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"heights", Value::array({Value::array({Value(1.0)})})}})}, {"expected", Value::array({Value::array({Value(0.0), Value(0.0)})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"heights", Value::array({Value::array({Value(1.0), Value(2.0), Value(3.0)}), Value::array({Value(8.0), Value(9.0), Value(4.0)}), Value::array({Value(7.0), Value(6.0), Value(5.0)})})}})}, {"expected", Value::array({Value::array({Value(0.0), Value(2.0)}), Value::array({Value(1.0), Value(0.0)}), Value::array({Value(1.0), Value(1.0)}), Value::array({Value(1.0), Value(2.0)}), Value::array({Value(2.0), Value(0.0)}), Value::array({Value(2.0), Value(1.0)}), Value::array({Value(2.0), Value(2.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"heights", Value::array({Value::array({Value(10.0), Value(10.0), Value(10.0)}), Value::array({Value(10.0), Value(1.0), Value(10.0)}), Value::array({Value(10.0), Value(10.0), Value(10.0)})})}})}, {"expected", Value::array({Value::array({Value(0.0), Value(0.0)}), Value::array({Value(0.0), Value(1.0)}), Value::array({Value(0.0), Value(2.0)}), Value::array({Value(1.0), Value(0.0)}), Value::array({Value(1.0), Value(2.0)}), Value::array({Value(2.0), Value(0.0)}), Value::array({Value(2.0), Value(1.0)}), Value::array({Value(2.0), Value(2.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"heights", Value::array({Value::array({Value(1.0), Value(1.0)}), Value::array({Value(1.0), Value(1.0)}), Value::array({Value(1.0), Value(1.0)})})}})}, {"expected", Value::array({Value::array({Value(0.0), Value(0.0)}), Value::array({Value(0.0), Value(1.0)}), Value::array({Value(1.0), Value(0.0)}), Value::array({Value(1.0), Value(1.0)}), Value::array({Value(2.0), Value(0.0)}), Value::array({Value(2.0), Value(1.0)})})}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"heights"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto arg0 = toIntMatrix(raw0);
        auto result = sol.pacificAtlantic(arg0);
