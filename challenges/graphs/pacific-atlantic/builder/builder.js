...
const TESTS = JSON.parse("[{\"input\":{\"heights\":[[1,2,2,3,5],[3,2,3,4,4],[2,4,5,3,1],[6,7,1,4,5],[5,1,1,2,4]]},\"expected\":[[0,4],[1,3],[1,4],[2,2],[3,0],[3,1],[4,0]],\"visible\":true},{\"input\":{\"heights\":[[1]]},\"expected\":[[0,0]],\"visible\":true},{\"input\":{\"heights\":[[1,2,3],[8,9,4],[7,6,5]]},\"expected\":[[0,2],[1,0],[1,1],[1,2],[2,0],[2,1],[2,2]],\"visible\":false},{\"input\":{\"heights\":[[10,10,10],[10,1,10],[10,10,10]]},\"expected\":[[0,0],[0,1],[0,2],[1,0],[1,2],[2,0],[2,1],[2,2]],\"visible\":false},{\"input\":{\"heights\":[[1,1],[1,1],[1,1]]},\"expected\":[[0,0],[0,1],[1,0],[1,1],[2,0],[2,1]],\"visible\":false}]");
...
function run(solutionPath, testsPath, challengePath) {
    ...
    const fn = resolveFunction(solution, ["pacificAtlantic"]);
    const caseInput = test.input;
    let args = [];
    if (isObject(caseInput)) {
        args = ["heights"].map((key) => caseInput[key]);
    } else if (Array.isArray(caseInput) && ["heights"].length > 1) {
        args.push(caseInput);
