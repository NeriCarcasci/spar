...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"grid", Value::array({Value::array({Value("1"), Value("1"), Value("1"), Value("1"), Value("0")}), Value::array({Value("1"), Value("1"), Value("0"), Value("1"), Value("0")}), Value::array({Value("1"), Value("1"), Value("0"), Value("0"), Value("0")}), Value::array({Value("0"), Value("0"), Value("0"), Value("0"), Value("0")})})}})}, {"expected", Value(1.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"grid", Value::array({Value::array({Value("1"), Value("1"), Value("0"), Value("0"), Value("0")}), Value::array({Value("1"), Value("1"), Value("0"), Value("0"), Value("0")}), Value::array({Value("0"), Value("0"), Value("1"), Value("0"), Value("0")}), Value::array({Value("0"), Value("0"), Value("0"), Value("1"), Value("1")})})}})}, {"expected", Value(3.0)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"grid", Value::array({Value::array({Value("0")})})}})}, {"expected", Value(0.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"grid", Value::array({Value::array({Value("1")})})}})}, {"expected", Value(1.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"grid", Value::array({Value::array({Value("1"), Value("0"), Value("1")}), Value::array({Value("0"), Value("1"), Value("0")}), Value::array({Value("1"), Value("0"), Value("1")})})}})}, {"expected", Value(5.0)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"grid", Value::array({Value::array({Value("1"), Value("1")}), Value::array({Value("1"), Value("1")})})}})}, {"expected", Value(1.0)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"grid"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.numIslands(arg0);
