...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"adjList", Value::array({Value::array({Value(2.0), Value(4.0)}), Value::array({Value(1.0), Value(3.0)}), Value::array({Value(2.0), Value(4.0)}), Value::array({Value(1.0), Value(3.0)})})}})}, {"expected", Value::array({Value::array({Value(2.0), Value(4.0)}), Value::array({Value(1.0), Value(3.0)}), Value::array({Value(2.0), Value(4.0)}), Value::array({Value(1.0), Value(3.0)})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"adjList", Value::array({Value::array({})})}})}, {"expected", Value::array({Value::array({})})}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"adjList", Value::array({})}})}, {"expected", Value::array({})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"adjList", Value::array({Value::array({Value(2.0)}), Value::array({Value(1.0), Value(3.0)}), Value::array({Value(2.0)})})}})}, {"expected", Value::array({Value::array({Value(2.0)}), Value::array({Value(1.0), Value(3.0)}), Value::array({Value(2.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"adjList", Value::array({Value::array({Value(2.0), Value(3.0), Value(4.0)}), Value::array({Value(1.0)}), Value::array({Value(1.0)}), Value::array({Value(1.0)})})}})}, {"expected", Value::array({Value::array({Value(2.0), Value(3.0), Value(4.0)}), Value::array({Value(1.0)}), Value::array({Value(1.0)}), Value::array({Value(1.0)})})}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"adjList", Value::array({Value::array({Value(2.0)}), Value::array({Value(1.0), Value(3.0)}), Value::array({Value(2.0), Value(4.0)}), Value::array({Value(3.0), Value(5.0)}), Value::array({Value(4.0)})})}})}, {"expected", Value::array({Value::array({Value(2.0)}), Value::array({Value(1.0), Value(3.0)}), Value::array({Value(2.0), Value(4.0)}), Value::array({Value(3.0), Value(5.0)}), Value::array({Value(4.0)})})}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"adjList"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        gotValue = graphToValue(sol.cloneGraph(buildGraph(getField(input, "adjList"))));
