...
const testsJSON = "[{\"input\":{\"numCourses\":2,\"prerequisites\":[[1,0]]},\"expected\":true,\"visible\":true},{\"input\":{\"numCourses\":2,\"prerequisites\":[[1,0],[0,1]]},\"expected\":false,\"visible\":true},{\"input\":{\"numCourses\":1,\"prerequisites\":[]},\"expected\":true,\"visible\":false},{\"input\":{\"numCourses\":5,\"prerequisites\":[[1,0],[2,1],[3,2],[4,3]]},\"expected\":true,\"visible\":false},{\"input\":{\"numCourses\":4,\"prerequisites\":[[1,0],[2,0],[3,1],[3,2]]},\"expected\":true,\"visible\":false},{\"input\":{\"numCourses\":3,\"prerequisites\":[[0,1],[1,2],[2,0]]},\"expected\":false,\"visible\":false},{\"input\":{\"numCourses\":5,\"prerequisites\":[]},\"expected\":true,\"visible\":false}]"
...
func main() {
    ...
    argKeys := []string{"numCourses", "prerequisites"}
    _ = argKeys
    failed := false
    for i, test := range tests {
        ...
        arg1 := toIntMatrix(raw1)
        result := CanFinish(arg0, arg1)
