...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"numCourses", Value(2.0)}, {"prerequisites", Value::array({Value::array({Value(1.0), Value(0.0)})})}})}, {"expected", Value(true)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"numCourses", Value(2.0)}, {"prerequisites", Value::array({Value::array({Value(1.0), Value(0.0)}), Value::array({Value(0.0), Value(1.0)})})}})}, {"expected", Value(false)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"numCourses", Value(1.0)}, {"prerequisites", Value::array({})}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"numCourses", Value(5.0)}, {"prerequisites", Value::array({Value::array({Value(1.0), Value(0.0)}), Value::array({Value(2.0), Value(1.0)}), Value::array({Value(3.0), Value(2.0)}), Value::array({Value(4.0), Value(3.0)})})}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"numCourses", Value(4.0)}, {"prerequisites", Value::array({Value::array({Value(1.0), Value(0.0)}), Value::array({Value(2.0), Value(0.0)}), Value::array({Value(3.0), Value(1.0)}), Value::array({Value(3.0), Value(2.0)})})}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"numCourses", Value(3.0)}, {"prerequisites", Value::array({Value::array({Value(0.0), Value(1.0)}), Value::array({Value(1.0), Value(2.0)}), Value::array({Value(2.0), Value(0.0)})})}})}, {"expected", Value(false)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"numCourses", Value(5.0)}, {"prerequisites", Value::array({})}})}, {"expected", Value(true)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"numCourses", "prerequisites"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto arg0 = toInt(raw0);
        Value raw1 = getArg(testObj, argKeys, 1);
        auto arg1 = toIntMatrix(raw1);
        auto result = sol.canFinish(arg0, arg1);
