...
int main(int argc, char** argv) {
    ...
    std::vector<Value> tests = {
        Value::object({{"input", Value::object({{"n", Value(5.0)}, {"edges", Value::array({Value::array({Value(0.0), Value(1.0)}), Value::array({Value(0.0), Value(2.0)}), Value::array({Value(0.0), Value(3.0)}), Value::array({Value(1.0), Value(4.0)})})}})}, {"expected", Value(true)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"n", Value(5.0)}, {"edges", Value::array({Value::array({Value(0.0), Value(1.0)}), Value::array({Value(1.0), Value(2.0)}), Value::array({Value(2.0), Value(3.0)}), Value::array({Value(1.0), Value(3.0)}), Value::array({Value(1.0), Value(4.0)})})}})}, {"expected", Value(false)}, {"visible", Value(true)}}),
        Value::object({{"input", Value::object({{"n", Value(1.0)}, {"edges", Value::array({})}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"n", Value(4.0)}, {"edges", Value::array({Value::array({Value(0.0), Value(1.0)}), Value::array({Value(2.0), Value(3.0)})})}})}, {"expected", Value(false)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"n", Value(2.0)}, {"edges", Value::array({Value::array({Value(0.0), Value(1.0)})})}})}, {"expected", Value(true)}, {"visible", Value(false)}}),
        Value::object({{"input", Value::object({{"n", Value(3.0)}, {"edges", Value::array({Value::array({Value(0.0), Value(1.0)}), Value::array({Value(1.0), Value(2.0)}), Value::array({Value(0.0), Value(2.0)})})}})}, {"expected", Value(false)}, {"visible", Value(false)}})
    };
    std::vector<std::string> argKeys = {"n", "edges"};
    bool failed = false;
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        auto result = sol.validTree(arg0, arg1);
